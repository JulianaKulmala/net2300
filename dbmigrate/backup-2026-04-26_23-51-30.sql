...
CREATE TABLE `execution_log` (
  ...
  CONSTRAINT `execution_log_ibfk_1` FOREIGN KEY (`log_id`) REFERENCES `logs` (`id`) ON DELETE SET NULL
...
(1,1,'pwd','/root/net2300/dbmigrate',0,'2026-04-27 00:58:57'),
(2,1,'pwd','/root/net2300/dbmigrate',0,'2026-04-27 00:58:57'),
(3,1,'pwd','/root/net2300/dbmigrate',0,'2026-04-27 00:58:57'),
(4,2,'ls','APACHE.md\nbackend\ndbmigrate.log\ndocker-compose.override.yml.example\ndocker-compose.yml\nDOCKER.md\nDOCKER-SHARE.md\nexport-images.sh\nfrontend\ninit-databases.sql\nINSTALL-DOCKER.md\ninstall-docker-rocky.sh\nMakefile\nmysqlsampledatabase.sql\nNODEJS-DOCKER.md\nopen-ports.sh\nREADME.md\nstart-engine.sh\nSTATUS-FIELD-UPDATE.md\nverify-docker.sh',0,'2026-04-27 00:59:06'),
(5,3,'date','Sun Apr 26 08:59:11 PM EDT 2026',0,'2026-04-27 00:59:11'),
(6,NULL,'whom','./start-engine.sh: line 22: whom: command not found',127,'2026-04-27 00:59:16'),
(7,5,'whoami','root',0,'2026-04-27 00:59:26'),
(8,6,'lss','./start-engine.sh: line 22: lss: command not found',127,'2026-04-27 00:59:48'),
(9,6,'lss','./start-engine.sh: line 22: lss: command not found',127,'2026-04-27 00:59:48'),
(10,6,'lss','./start-engine.sh: line 22: lss: command not found',127,'2026-04-27 00:59:48'),
(11,7,'pwdd','./start-engine.sh: line 22: pwdd: command not found',127,'2026-04-27 00:59:53'),
(12,7,'pwdd','./start-engine.sh: line 22: pwdd: command not found',127,'2026-04-27 00:59:53'),
(13,7,'pwdd','./start-engine.sh: line 22: pwdd: command not found',127,'2026-04-27 00:59:53'),
(14,8,'echo \"hello','./start-engine.sh: eval: line 22: unexpected EOF while looking for matching `\"\'',2,'2026-04-27 01:00:16');
...
(1,'pwd','done','2026-04-27 00:58:57'),
(2,'ls','done','2026-04-27 00:59:03'),
(3,'date','done','2026-04-27 00:59:08'),
(5,'whoami','done','2026-04-27 00:59:25'),
(6,'lss','error','2026-04-27 00:59:47'),
(7,'pwdd','error','2026-04-27 00:59:51'),
(8,'echo \"hello','error','2026-04-27 01:00:15');
...
-- Dump completed on 2026-04-26 23:51:30
